...
class ChangeViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let typeArray = ["Marketer_before","Marketer_after","Engineer_before","Engineer_after"]
        for i in 0...3 {
            for j in 0...5 {
                ...
                marketView.tag = j+1
                marketView.type = typeArray[i]//jobTypeArray[i]
                self.view.addSubview(marketView)
                marketView.propertyLabel.hidden = false
                if i%2 == 0 {
                    var employee = employeesDic[jobTypeArray[i/2]]![marketNameArray[j]]!
